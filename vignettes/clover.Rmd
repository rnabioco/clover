...
# Use tRNA-only FASTA (no adapters) so positions match bcerror coordinates
...
# Shorten tRNA labels for display (e.g., "tRNA-Glu-TTC-1-1" -> "Glu-TTC")
bcerror_sprinzl <- bcerror_sprinzl |>
  mutate(trna_label = sub("^tRNA-", "", ref) |> sub("-\\d+-\\d+$", "", x = _))
